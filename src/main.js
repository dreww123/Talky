...
async function init() {
  ...
  try {
    ...
    // RAW packaged-app config: no Vite, no import.meta.env
    const TOKEN = "INSERT_YOUR_SECRET_TOKEN_HERE";
    const API_BASE = "https://talky-production-fa31.up.railway.app";
    const WS_BASE = "wss://talky-production-fa31.up.railway.app";

    if (!TOKEN || TOKEN === "INSERT_YOUR_SECRET_TOKEN_HERE") {
      throw new Error("TOKEN not set in main.js");
    }
